...
COLUMN_NAME_NUMBERS.update({
    "AccessControl": {"uid": 0, "name": 1, "commonname": 2, "invokingid": 3, "invokingobject": 3, "methodid": 4, "method": 4, "ace": 5, "acelist": 5, "aces": 5},
    "DataStore": {"uid": 0, "name": 1, "commonname": 2, "startrow": 3, "endrow": 4, "value": 5},
    "SP": {"uid": 0, "name": 1, "commonname": 2, "lifecycle": 3, "enabled": 4, "frozen": 5},
    "MethodID": {"uid": 0, "name": 1, "commonname": 2},
})
...
RULE_REFERENCES = {
    ...
    "status": ("core/3.3.4.1", "core/5.3.3"),
...
def normalize_authority_name(value):
    ...
    if not text:
        return None
    lowered = text.lower()
    if lowered in {"sid", "admins", "anybody"}:
