...
`v4` solver는 deterministic rule-based SSD/TCG protocol oracle이다. 모델이나 네트워크를 사용하지 않고, testcase의 command-response trajectory를 읽어서 마지막 response가 현재 프로토콜 상태와 일치하는지 판단한다.
